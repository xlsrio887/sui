...
import { Keypair, PRIVATE_KEY_SIZE, encodeSuiKeyPair } from '../../cryptography/keypair.js';
...
export class Ed25519Keypair extends Keypair {
	...
	export(): ExportedKeypair {
		return {
			schema: 'ED25519',
			privateKey: encodeSuiKeyPair(this.keypair.secretKey.slice(0, PRIVATE_KEY_SIZE), this.getKeyScheme()),
		};
	}
}
